...
<tbody>
<tr><td><strong>1. Mint a Mining Rig</strong></td><td>For 0.0018 ETH, solve an SMHL challenge and mint an ERC-8004 agent identity NFT. Each rig has a rarity tier and hashpower multiplier. Mint fees bootstrap protocol-owned liquidity.</td></tr>
